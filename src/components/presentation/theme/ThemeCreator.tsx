...
export function ThemeCreator({ children }: { children?: ReactNode }) {
  ...
  const form = useForm<ThemeFormValues>({
    defaultValues: {
      ...
      themeBase: "porsche",
      colors: {
        light: { ...themes.porsche.colors.light },
        dark: { ...themes.porsche.colors.dark },
      },
      fonts: { ...themes.porsche.fonts },
      borderRadius: themes.porsche.borderRadius,
      transitions: { ...themes.porsche.transitions },
      shadows: {
        light: { ...themes.porsche.shadows.light },
        dark: { ...themes.porsche.shadows.dark },
      },
    },
  });
